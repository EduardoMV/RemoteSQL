...
│   ├── requirements.txt
│   └── .env.example     ← Copy this to .env and fill your DB credentials
│
├── database/
...
- [guides/github-upload.md](guides/github-upload.md) — Push the project to GitHub, tokens, collaboration with Raschid
...
- [ ] ERD diagram (PDF for submission)
- [ ] Architecture diagram (for submission)

### Planned 📋

- [ ] Docker Compose setup (one command to start everything)
- [ ] Query execution time display in results toolbar
- [ ] Pagination for large result sets (> 500 rows)
- [ ] Basic auth on the API (API key header)
